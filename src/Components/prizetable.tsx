...
const PrizeTable = () => {
  ...
  const rows = [
    ...
    { label: "+600 Participantes", values: ["R$5.000,00", "R$2.000,00", "R$1.000,00", "-", "-", "-", "-", "-", "-", "-", "R$1.000,00"] },
    { label: "+600 Participantes", values: ["R$5.000,00", "R$2.000,00", "R$1.000,00", "R$1.000,00", "-", "-", "-", "-", "-", "-", "R$1.000,00"] },
    { label: "+600 Participantes", values: ["R$5.000,00", "R$2.000,00", "R$1.000,00", "R$1.000,00", "-", "-", "-", "-", "-", "-", "R$1.000,00"] },
    { label: "+600 Participantes", values: ["R$5.000,00", "R$2.000,00", "R$1.000,00", "R$1.000,00", "R$1.000,00", "R$1.000,00", "-", "-", "-", "-", "R$1.000,00"] },
    { label: "+600 Participantes", values: ["R$5.000,00", "R$2.000,00", "R$1.000,00", "-", "-", "-", "-", "-", "-", "-", "R$1.000,00"] },
    { label: "+600 Participantes", values: ["R$5.000,00", "R$2.000,00", "R$1.000,00", "-", "-", "-", "-", "-", "-", "-", "R$1.000,00"] },
